...
if st.button("Predict"):
    ...
    f"Employment Status={feature_values[4]}",
    f"Education Level={feature_values[5]}",
    f"Healthcare Payment Method={feature_values[6]}",
    ...
    f"Experience with Pregnancy Termination={feature_values[11]}",
    ...
    f"Does the Newborn Have Birth Defects or Diseases={feature_values[16]}",
    f"Average Monthly Household Income per Capita={feature_values[17]}",
    f"Use of Pain-Free Delivery Technology={feature_values[18]}",
    f"Pain During Delivery={feature_values[19]}",
    f"Postpartum Pain={feature_values[20]}",
    f"Postpartum Infant Care Method={feature_values[21]}",
    f"Sleep Quality in the Past Month={feature_values[22]}",
    f"Nighttime Sleep Duration in the Past Month={feature_values[23]}",
    f"Fatigue Level in the Past Month={feature_values[24]}",
    f"Physical Activity Level During Pregnancy={feature_values[25]}",
    ...
    f"Psychological Resilience={feature_values[30]}",
